        ...
        public async Task<bool> EvaluateAsync(FeatureFilterEvaluationContext context)
        {
            ...
            if (_httpContextAccessor.HttpContext != null)
            {
                result = _httpContextAccessor.HttpContext.User.HasClaim(
                    ...
                    featureManagementCore.ModuleConstants.Security.Permissions.Developer);
            }
            else
            {
                ...
                if (!currentUserName.EqualsInvariant("unknown"))
                {
                    ...
                    result = currentUser
                        ...
                        .Any(x =>
                            ...
                            x.Value.EqualsInvariant(featureManagementCore.ModuleConstants.Security.Permissions.Developer));
                }
                else
                {
